...
(function ($) {
                ...
                .on("mouseenter", function (e) {
                    ...
                    $(document)
                        ...
                        .on("mousemove", function (e) {
                            gsap.to(".thumb-info-floating-element-clone", 0.5, { css: { left: e.clientX + offset, top: e.clientY + offset } });
                        });
                })
    ...
    $(window).on("load", function () {
        $(".thumb-info-wrapper-direction-aware").each(function () {
            $(this).hoverdir({ speed: 300, easing: "ease", hoverDelay: 0, inverse: false, hoverElem: ".thumb-info-wrapper-overlay" });
        });
    });
...
(function (theme, $) {
    ...
    PluginAnimate.defaults = { accX: 0, accY: -80, delay: 100, duration: "750ms", minWindowWidth: 767, forceAnimation: false, flagClassOnly: false };
...
(function (theme, $) {
    ...
    PluginAnimatedContent.defaults = { contentType: "letter", animationName: "fadeIn", animationSpeed: 50, startDelay: 500, minWindowWidth: 768, letterClass: "", wordClass: "", wrapperClass: "" };
        ...
        build: function () {
            ...
            if (self.options.contentType == "letter") {
                ...
                $.each(words, function (i, v) {
                    self.$el.append(
                        $('<span class="animated-words-wrapper ' + self.options.wrapperClass + '">').html(
                            '<span class="animated-words-item ' + self.options.wordClass + ' appear-animation" data-appear-animation="' + self.options.animationName + '" data-appear-animation-delay="' + delay + '">' + v + "&nbsp;</span>"
                        )
                    );
...
(function (theme, $) {
    ...
    PluginCarousel.defaults = { loop: true, responsive: { 0: { items: 1 }, 479: { items: 1 }, 768: { items: 2 }, 979: { items: 3 }, 1199: { items: 4 } }, navText: [], refresh: false };
...
(function (theme, $) {
    ...
    PluginCountdown.defaults = { date: "2030/06/10 12:00:00", textDay: "DAYS", textHour: "HRS", textMin: "MIN", textSec: "SEC", uppercase: true, numberClass: "", wrapperClass: "", insertHTMLbefore: "", insertHTMLafter: "" };
    ...
    PluginCursorEffect.prototype = {
        ...
        events: function () {
            ...
            $("[data-cursor-effect-hover]").on("mouseleave", function () {
                ...
                switch ($(this).data("cursor-effect-hover")) {
                    case "fit":
                        $cursorOuter.css({ width: initialCursorOuterBox.width, height: initialCursorOuterBox.height, "border-radius": initialCursorOuterRadius }).removeClass("cursor-outer-fit");
...
(function (theme, $) {
    ...
    PluginFloatElement.defaults = { startPos: "top", speed: 3, horizontal: false, isInsideSVG: false, transition: false, transitionDelay: 0, transitionDuration: 500 };
...
(function (theme, $) {
    ...
    PluginHoverEffect.defaults = { effect: "magnetic", magneticMx: 0.15, magneticMy: 0.3, magneticDeg: 12, selector: ".thumb-info, .hover-effect-3d-wrapper", sensitivity: 20 };
...
(function (theme, $) {
    ...
    PluginIcon.defaults = { color: "#2388ED", animated: false, delay: 300, onlySVG: false, removeClassAfterInit: false, fadeIn: true, accY: 0 };
                ...
                success: function (data, status, xhr) {
                    ...
                    var icon = new Vivus(uniqid, {
                        ...
                        onReady: function (obj) {
                            ...
                            if ((self.options.animated && self.options.strokeBased) || (!self.options.animated && color && self.options.strokeBased)) {
                                styleElement.textContent =
                                    "#" + uniqid + " path, #" + uniqid + " line, #" + uniqid + " rect, #" + uniqid + " circle, #" + uniqid + " polyline { stroke: " + color + "; " + (self.options.svgStyle ? self.options.svgStyle : "") + "}";
                                obj.el.appendChild(styleElement);
                            }
...
(function (theme, $) {
    ...
    PluginInViewportStyle.defaults = { viewport: window, threshold: [0], modTop: "-200px", modBottom: "-200px", style: { transition: "all 1s ease-in-out" }, styleIn: "", styleOut: "", classIn: "", classOut: "" };
        ...
        build: function () {
            ...
            if (typeof window.IntersectionObserver === "function") {
                const un = observeElementInViewport.observeElementInViewport(
                    ...
                    { viewport: self.options.viewport, threshold: self.options.threshold, modTop: self.options.modTop, modBottom: self.options.modBottom }
                );
            }
            return this;
        },
...
(function (theme, $) {
    ...
    PluginReadMore.prototype = {
        ...
        build: function () {
            ...
            self.options.wrapper.find(".readmore-overlay").css({ background: backgroundCssValue, position: "absolute", bottom: 0, left: 0, width: "100%", height: self.options.overlayHeight, "z-index": 1 });
            self.options.wrapper.find(".readmore-button-wrapper").removeClass("d-none").css({ position: "absolute", bottom: 0, left: 0, width: "100%", "z-index": 2 });
...
(function (theme, $) {
    ...
    $.extend(theme, {
        PluginScrollToTop: {
            defaults: { wrapper: $("body"), offset: 150, buttonClass: "scroll-to-top", buttonAriaLabel: "Scroll To Top", iconClass: "fas fa-chevron-up", delay: 1000, visibleMobile: false, label: false, easing: "easeOutBack" },
            ...
            build: function () {
                var self = this,
                    $el;
                $el = $("<a />").addClass(self.options.buttonClass).attr({ href: "#", "aria-label": self.options.buttonAriaLabel }).append($("<i />").addClass(self.options.iconClass));
...
(function (theme, $) {
    ...
    PluginVideoBackground.defaults = { overlay: false, volume: 1, playbackRate: 1, muted: true, loop: true, autoplay: true, position: "50% 50%", posterType: "detect", className: "vide-video-wrapper" };
